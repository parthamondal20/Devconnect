        ...
        <header className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16 gap-4">
                    ...
                    {/* 🔹 1. Logo */}
                    <Link to={!location.pathname.includes("/feed") && !location.pathname.includes("/") ? "/feed" : null} className="flex-shrink-0 flex items-center gap-2 group">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        {user ? (
                            ...
                            <Link
                                to="/signin"
                                className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-full bg-blue-600 text-white text-sm font-medium hover:bg-blue-700 transition-colors shadow-sm shadow-blue-600/20"
                            >
